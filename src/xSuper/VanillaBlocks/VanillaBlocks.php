...
use xSuper\VanillaBlocks\blocks\BeeNest;
use xSuper\VanillaBlocks\blocks\Beehive;
...
use xSuper\VanillaBlocks\blocks\Chain;
...
class VanillaBlocks extends PluginBase implements Listener {
	...
	public static function Init(): void
	{
		...
		self::registerBlock(new BeeNest(VanillaBlockIds::BEE_NEST, "Bee Nest"));
		self::registerBlock(new Beehive(VanillaBlockIds::BEEHIVE, "Beehive"));
	...
	public function onPlayerMove(PlayerMoveEvent $event): void
	{
		...
		/** @var Block */
		$to = $level->getBlock($event->getTo());
		/** @var Block */
		$from = $level->getBlock($event->getFrom());
		/** @var Block */
		$under = $level->getBlock(new Position($to->x, $to->y - 1, $to->z, $level));
